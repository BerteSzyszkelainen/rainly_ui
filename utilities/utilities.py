...
def generate_slider_marks(days_count, tick_postfix):
    if days_count < 3:
        ...
        marks = {i: {'label': '{}{}'.format(i, tick_postfix), 'style': {'font-size': 25, 'color': 'white'}} for i in [1, 2, 3]}
    elif days_count < 14:
        marks = {i: {'label': '{}{}'.format(i, tick_postfix), 'style': {'font-size': 25, 'color': 'white'}} for i in [1, 2, 3, 7]}
    elif days_count < 21:
        marks = {i: {'label': '{}{}'.format(i, tick_postfix), 'style': {'font-size': 25, 'color': 'white'}} for i in [1, 2, 3, 7, 14]}
    elif days_count < 28:
        marks = {i: {'label': '{}{}'.format(i, tick_postfix), 'style': {'font-size': 25, 'color': 'white'}} for i in
                 [1, 2, 3, 7, 14, 21]}
    else:
    ...
    if days_count < 28:
        marks.update({days_count: {'label': '{}{}'.format(days_count, tick_postfix), 'style': {'font-size': 25, 'color': 'white'}}})
